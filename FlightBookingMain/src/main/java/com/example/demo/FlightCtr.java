...
//			if(bookedSeats>=110) {
//				flexrate = new Double(flexiConf.get("110").toString());
//			} else if(bookedSeats>=90) {
//				flexrate = new Double(flexiConf.get("90").toString());
//			} else if(bookedSeats>=60) {
//				flexrate = new Double(flexiConf.get("60").toString());
//			}
			Map resp = new HashMap();
			resp.put("total_seats", f1.getTotalSeats());
			resp.put("available_seats", (f1.getTotalSeats()-bookedSeats));
			resp.put("max_booking_limit", maxConf.get("message"));
			resp.put("flexi_rate", baserate + flexrate);
